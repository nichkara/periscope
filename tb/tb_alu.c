...
int main(void) {
    ...
    (void)printf("-- Author(s): Nina Chlóe Kassandra Reiß <nina.reiss@nickr.eu>\n");
    ...
    (void)printf("            Operation_Code => alu_opc_tb,\n");
    (void)printf("            Operand_1  => input1_tb,\n");
    (void)printf("            Operand_2  => input2_tb,\n");
